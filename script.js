...
console.log("After setting completed for gyms below difficulty 3:");
console.log("EXERCISE 3", game.gyms);
...
*/
// console.log("Pokémon in party:");
// // Access the party array within the game object
...
// Example usage:
const pokemonToAdd = pokemon.find((p) => p.name === "Pikachu");
game.catchPokemon(pokemonToAdd);
...
game.catchPokemon = function (pokemonObj) {
  ...
  const pokeballIndex = this.items.findIndex(
...
console.log("After completing gyms below difficulty 6:");
...
console.log("Number of Pokémon in party:");
...
console.log("After completing gyms below difficulty 8:");
console.log(game.gyms);
